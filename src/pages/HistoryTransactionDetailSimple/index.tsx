    ...
    return (
        ...
        createPortal(
            <div className="ml-0 md:ml-[240px] absolute top-0 right-0 left-0 bottom-0 bg-black bg-opacity-50 animate-fadeIn">
                <Grid variant="lg" title={<>Viewing transaction</>}>
                    <div className="mx-4 mb-4 rounded bg-white bg-opacity-90 p-4 items-center">
                        <div className="grid grid-cols-1 grid-rows-1 pb-4">
                            <div className="flex flex-col">
                                <p className="text-black">{params.transactionid}</p>
                                <Button onClick={() => navigate(-1)}>Dismiss</Button>
                            </div>
                        </div>
                        <div />
                    </div>
