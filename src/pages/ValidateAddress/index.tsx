    ...
    return (
        ...
        >
            <Card>
                ...
                >
                    {({ handleSubmit, getFieldProps, isValid, isSubmitting, values, resetForm, touched, errors }) => (
                        <>
                            {step === 1 &&
                                validationData &&
                                createPortal(
                                    <div className="ml-0 md:ml-[240px] absolute top-0 right-0 left-0 bottom-0 bg-black bg-opacity-50 animate-fadeIn">
                                        <Grid variant="lg" title={<></>}>
                                            <div className="mx-4 rounded bg-white bg-opacity-90 p-4">
                                                <h1 className="text-black font-semibold mb-8">Validation report</h1>
                                                <div className="divide-y-2 mb-8">
                                                    <KeyValue title="Validating address" value={values.address} />
                                                    <KeyValue title="Original" value={validationData.original} />
                                                    <KeyValue title="0x" value={validationData['0x']} />
                                                    <KeyValue title="Mx" value={validationData['Mx']} />
                                                    <KeyValue
                                                        title="Relevant"
                                                        value={validationData.relevant ? 'True' : 'False'}
                                                    />
                                                    <KeyValue
                                                        title="Simple"
                            ...
                            <form onSubmit={handleSubmit}>
                                <div>
                                    <h1 className="text-black mb-4 font-semibold">Validate an 0x or Mx address</h1>
                                    <Input
                                    ...
                                    />
                                    <Button extraClass="mt-4" type="submit" variant="primary" disabled={!isValid}>
                                        Validate
                                    </Button>
                                </div>
                            </form>
