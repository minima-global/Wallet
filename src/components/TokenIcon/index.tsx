...
const TokenIcon = ({ token, tokenId }: { token: any, tokenId: string }) => {
    ...
    if (token === 'Minima') {
        return (
            <div className="min-w-[48px] w-[48px] h-[48px] border border-darkConstrast dark:border-grey80 rounded-sm overflow-hidden">
    ...
    if (typeof token === 'object' && token.url) {
        return (
            <div className="min-w-[48px] w-[48px] h-[48px] border border-contrast2 rounded overflow-hidden">
    ...
    return (
        <div className="min-w-[48px] w-[48px] h-[48px] border border-contrast2 bg-contrast1 rounded overflow-hidden">
