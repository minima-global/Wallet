...
const MockToken = ({ t, step }: any) => {
    const { makeMinimaNumber } = useFormatMinimaNumber();
    return (
        <div className="flex items-center space-x-2 hover:bg-slate-100 hover:cursor-pointer border border-neutral-200 bg-neutral-50 rounded-lg mb-4 pr-3">
            ...
            <div className="flex-shrink-0 flex flex-col items-end mr-4">
                <div className={`flex items-center space-x-1 ${step === 1 && 'animate-pulse'}`}>
                    <p className="text-xs">
                        {step === 1 && '->'}{' '}
