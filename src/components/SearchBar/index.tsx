...
const SearchBar = ({ placeholder, value, onChange, className }: { placeholder?: string, value: string, onChange: (value: string) => void, className?: string }) => {
    ...
    return (
        <div className={`h-[44px] flex dark:bg-darkContrast border border-grey40 dark:border-mediumDarkContrast rounded-full flex-1 ${className}`}>
            ...
            <div className="relative w-full">
                ...
                />
                {value && (
                    <button onClick={handleClear} className="text-sm text-grey60 absolute top-0 right-4 flex h-full items-center z-10">
