...
const TokenCard = ({ balance, favourted }: { balance: Balance, favourted: boolean }) => {
    return (
        <Link to="/balance/$id" params={{ id: balance.tokenid }} className="group col-span-6 lg:col-span-3 flex flex-col h-full items-stretch">
            <div className="bg-[#0f0f0f] h-full min-h-[220px] max-h-[220px] flex items-center justify-center relative rounded-t w-full h-full overflow-hidden">
            ...
            <div className="bg-contrast1 group-hover:bg-contrast2 transition-all duration-100 py-3 px-4 rounded-b">
                <div className="grid grid-cols-2">
                    <div className="col-span-2">
                        <h5 className="text-white">{renderTokenName(balance)}</h5>
