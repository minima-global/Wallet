...
const LanguageSelector = ({ isAtTop }: { isAtTop: boolean }) => {
    ...
    return (
        <div>
            <div onClick={toggleOpen} className="relative z-20 cursor-pointer text-white border-2 border-contrast2 rounded-full px-3 w-full transition-all active:scale-[95%] flex gap-2 py-1.5 pl-3.5 pr-2.5">
