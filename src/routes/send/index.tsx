            ...
            <div className="mt-10 container mx-auto flex">
                <div className="flex w-full gap-10">
                    ...
                    <div className="grow flex flex-col">
                        <h1 className="text-white text-2xl mb-6">Send</h1>
                        ...
                        <div className="mt-5 mb-8 flex flex-col gap-4">
                            <div>
                                ...
                                <div className="bg-grey10 dark:bg-darkContrast px-4 py-3.5 rounded ">
                                    <div className="flex">
                                        <input required name="amount" placeholder="Enter amount" className="text-sm bg-transparent w-full placeholder-grey60 appearance-none outline-none" value="" />
                                    </div>
                                </div>
                            </div>

                            <div>
                                <div className="dark:text-grey40 mb-3">Recipient address</div>
                                <div className="bg-grey10 dark:bg-darkContrast px-4 py-3.5 rounded ">
                                    <div className="flex">
                                        <input required name="amount" placeholder="Enter amount" className="text-sm bg-transparent w-full placeholder-grey60 appearance-none outline-none" value="" />
                                    </div>
                            ...
                            <div>
                                <div className="dark:text-grey40 mb-3">Message</div>
                                <div className="bg-grey10 dark:bg-darkContrast px-4 py-3.5 rounded ">
                                    <div className="flex">
                                        <input required name="amount" placeholder="Enter amount" className="text-sm bg-transparent w-full placeholder-grey60 appearance-none outline-none" value="" />
                                    </div>
                            ...
                            <div>
                                <div className="dark:text-grey40 mb-3">Add a burn <span className="text-grey60 text-sm">(Optional)</span></div>
                                <div className="bg-grey10 dark:bg-darkContrast px-4 py-3.5 rounded ">
                                    <div className="flex">
                                        <input required name="amount" placeholder="Enter amount" className="text-sm bg-transparent w-full placeholder-grey60 appearance-none outline-none" value="" />
                                    </div>
