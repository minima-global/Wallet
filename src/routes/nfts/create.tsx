          ...
          <div className="grow flex flex-col mb-20">
            <div>
              ...
              <form className="mt-6 flex flex-col gap-6">
                ...
                />
                <Input
                  label="Web validation URL (Optional)"
                ...
                <Input
                  label="Tags (Optional)"
                  placeholder="Enter tags for your NFT"
                  value=""
                  onChange={() => {}}
                />
              </form>
